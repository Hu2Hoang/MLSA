...
document.getElementById('addRecordButton').addEventListener('click', function() {
    ...
    var Avatar = "https://https://https://firebasestorage.googleapis.com/v0/b/mlsa-fd0c1.appspot.com/o/Noti2.png?alt=media&token=8e347df2-7ab9-484d-8a43-3f921d037ddb.googleapis.com/v0/b/mlsa-fd0c1.appspot.com/o/SkyHelper.png?alt=media&token=0e7407de-8a10-4fd0-988f-ef125b5bdc88.googleapis.com/v0/b/mlsa-fd0c1.appspot.com/o/DevCon.png?alt=media&token=976f873a-b873-4541-93ce-d9e28b7a4589";
    var Content = document.getElementById('Content').value;
    
    var newRecord = firebase.database().ref('noti').push();
